/**
 * 
 * Will help with air strikes on the Mars. Specialy designed to fly in Mars atmosphere.
 * 
 */
...
public class Helicopter extends DefenceWindow implements DefenceUnit {
			...
			.addGroup(layout.createSequentialGroup()
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
					...
					.addGroup(layout.createSequentialGroup()
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
							.addComponent(this.positionStateCheckBox, javax.swing.GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE)
	...
	public void sendMessage () {
		...
		this.controlRoom.recieveMessage(this.unitSendMGText.getText(), "Helicopter#" + this.unitID);
